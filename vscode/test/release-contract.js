...
const studioManifest = require('../../studio/package.json')
const desktopManifest = require('../../desktop/wails.json')
...
assert.equal(studioManifest.version, runtime, 'Studio and runtime versions must match')
assert.equal(desktopManifest.info.productVersion, runtime, 'desktop and runtime versions must match')
