...
func NewRouter() *docs.Router {
	...
	r.MustPage("/docs/http", docs.PageConfig{Title: "HTTP clients and services", Description: "Bounded HTTP requests and owned native service listeners.", SourcePath: "content/http.md", Order: 32, Offline: true})
	r.MustPage("/docs/files", docs.PageConfig{Title: "Files and folders", Description: "Canonical filesystem operations, traversal, and watchers.", SourcePath: "content/files.md", Order: 33, Offline: true})
	r.MustPage("/docs/time", docs.PageConfig{Title: "Time, timers, and schedules", Description: "Clock, timer, deadline, and calendar schedule operations.", SourcePath: "content/time.md", Order: 34, Offline: true})
